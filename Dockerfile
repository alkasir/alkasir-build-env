...
# install go
run mkdir -p /tmp/go-bootstrap && curl -sSL https://storage.googleapis.com/golang/go1.6.1.linux-amd64.tar.gz | tar -C /tmp/go-bootstrap -xz
run curl -sSL https://storage.googleapis.com/golang/go1.6.1.src.tar.gz | tar -C /usr/local -xz
